...
import org.playuniverse.minecraft.mcs.spigot.command.nodes.ForkNode;
...
public class CommandManager<S> {
    ...
    private CommandState registerPluginNode(PluginNode<S> node, String[] aliases) {
        ...
        return globalConflicts.isEmpty() ? CommandState.SUCCESS : CommandState.PARTIAL.setAliases(globalConflicts.toArray(String[]::new));
    }
