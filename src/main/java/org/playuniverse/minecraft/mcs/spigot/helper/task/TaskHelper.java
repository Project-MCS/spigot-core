package org.playuniverse.minecraft.mcs.spigot.helper.task;
...
public final class TaskHelper {
    ...
    public static final SynThreadReporter REPORTER = (throwable, var0, var1, var2) -> SpigotCore.get().getPluginLogger().log(throwable);
